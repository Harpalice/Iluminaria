...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Joan&family=Montserrat:wght@500&family=Nuosu+SIL&family=Playfair+Display:ital@1&family=Roboto:wght@100&family=Tiro+Devanagari+Hindi:ital@1&display=swap"
    rel="stylesheet">
...
<body>
  ...
  <!--carrusel-->
  <div class="container pt-4 pb-4" id="conte-carru">

    <div class="quienes mb-4">
      <h1>¿Quienes somos?</h1>
    </div>
    <div id="carouselExampleCaptions" class="carousel slide mt-4" data-bs-ride="false">
      ...
      <div class="carousel-inner" id="micarrusel">
        <div class="carousel-item active">
          <img src="imgsitio/local1.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block" id="mip">
            <p>Somos ILUMINARTE TANDIL y desde hace 20 años nos dedicamos a la venta de lámparas y artefactos para la iluminación profesional y decorativa.</p>
          </div>
        </div>
        <div class="carousel-item">
          <img src="imgsitio/local2.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block" id="mip">
            <p>El tiempo nos vió crecer con una filosofía de trabajo basada en la cuidadosa eleccion de productos, poniendo especial énfasis en el diseño y calidad, y en una atención profesional y personalizada, aportando soluciones lumínicas a profesionales, empresas y clientes en general.</p>
          </div>
        </div>
  ...
  <footer class="text-center text-white pt-4 pb-4" style="background-color: #000000;">
    ...
    <div class="container pt-4 mb-4" id="mirede">
      ...
      <section class="mb-4" id="misredes">
        <!-- Facebook -->
        <a class="btn btn-link btn-floating btn-lg text-white m-1" href="https://www.facebook.com/IluminarteTandil" role="button"
          data-mdb-ripple-color="text-white"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
          </svg></a>

        <!-- Instagram -->
        <a class="btn btn-link btn-floating btn-lg text-white m-1" href="https://instagram.com/iluminartetandil?igshid=YmMyMTA2M2Y=" role="button"
          data-mdb-ripple-color="text-white"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
        ...
        <!--Gmail-->
          ...
          data-mdb-ripple-color="text-white"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
