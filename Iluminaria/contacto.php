...
<body>
  ...
  <!--section-->
  <div class="container pt-4 pb-4" id="minum">
    <h1 class="mih1">Contactanos</h1>
    <div class="cont pt-4 pb-4">
        <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-lightbulb" viewBox="0 0 16 16">
            <path d="M2 6a6 6 0 1 1 10.174 4.31c-.203.196-.359.4-.453.619l-.762 1.769A.5.5 0 0 1 10.5 13a.5.5 0 0 1 0 1 .5.5 0 0 1 0 1l-.224.447a1 1 0 0 1-.894.553H6.618a1 1 0 0 1-.894-.553L5.5 15a.5.5 0 0 1 0-1 .5.5 0 0 1 0-1 .5.5 0 0 1-.46-.302l-.761-1.77a1.964 1.964 0 0 0-.453-.618A5.984 5.984 0 0 1 2 6zm6-5a5 5 0 0 0-3.479 8.592c.263.254.514.564.676.941L5.83 12h4.342l.632-1.467c.162-.377.413-.687.676-.941A5 5 0 0 0 8 1z"/>
          </svg>Fabricio Cano / Arquitecto</p>
        <a class="milink" href="https://api.whatsapp.com/message/WKZ4JBCQD32NF1?autoload=1&app_absent=0"><p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
        ...
        <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
          ...
          </svg>Iluminartetandil@yahoo.com.ar</p>
        ...
        <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar" viewBox="0 0 16 16">
          ...
          </svg>Horarios de Atencion:</p>
           <p>Lun-Vie: 09:00 a 13:00 / 16:00 a 19:30</p>
           <p>Sab 09:00 a 13:30</p>
    </div>
  </div>
