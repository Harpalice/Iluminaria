...
<head>
    ...
    <!--Mis estilos-->
    <link rel="stylesheet" href="iluminarte2.css">
...
<body>
                ...
                <div class="offcanvas-body" id="dentrodelmenu">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link active dropdown-toggle" href="#" id="offcanvasNavbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-lamp-fill" viewBox="0 0 16 16">
    ...
    <!--Section-->
    <div class="container pt-4" id="mitext">
        <div class="contetext" id="contetext">
            <h5 class="lh-1" id="mitextoinicial">La diferencia entre luz e iluminación.</h5>

            <p class="lh-1" id="mitextoinicial">
                Desde hace 19 años acompañamos a profesionales, estudios, empresas y clientes en general de Tandil y la zona, incorporando diseño y experiencia en la iluminación de viviendas, parques, espacios comerciales y obras de arquitectura con productos de calidad
                y el asesoramiento técnico adecuado.</p>
        </div>
    </div>
    ...
    <footer class="text-center text-white pt-4 pb-4" style="background-color: #000000;">
        ...
        <div class="container pt-4 mb-4" id="mirede">
            ...
            <section class="mb-4" id="misredes">
                <!-- Facebook -->
                <a class="btn btn-link btn-floating btn-lg text-white m-1" href="https://www.facebook.com/IluminarteTandil" role="button" data-mdb-ripple-color="text-white"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                ...
                <!-- Instagram -->
                <a class="btn btn-link btn-floating btn-lg text-white m-1" href="https://instagram.com/iluminartetandil?igshid=YmMyMTA2M2Y=" role="button" data-mdb-ripple-color="text-white"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                ...
                <!--Gmail-->
                <a class="btn btn-link btn-floating btn-lg text-white m-1" href="#!" role="button" data-mdb-ripple-color="text-white"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
